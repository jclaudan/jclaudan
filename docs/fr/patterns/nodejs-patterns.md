...
- [Patterns Asynchrones](#patterns-asynchrones)
...
Ce guide couvre tous les design patterns spécifiques à Node.js, incluant les paradigmes POO et fonctionnels avec des exemples pratiques.
